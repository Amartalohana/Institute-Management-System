            ...
            <div class="row justify-content-center">
                <div class="col-lg-4 col-md-8">
                    <div class="teachers-left mt-50">
                        <div class="hero">
                            <img src="images/teachers/favicon.png" alt="Teachers">
                        </div>
                        <div class="name">
                            <h6>JAIWANTI LOHANA</h6>
                            ...
                            <div class="tab-pane fade show active" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                                <div class="dashboard-cont">
                                    <div class="single-dashboard pt-40">
                                        <h5>About</h5>
                                        <p>A University Teacher post is usually a short term contract so can be seen as a stepping stone towards a permanent job or even part of a portfolio career. It is a useful job for those wishing to gain experience of working at different institutions.

To increase chances of being taken on in a full time post University Teachers are advised to be research active, publishing their work in journals and books and attending conferences, and being innovative in their teaching practice..</p>
                                    </div> <!-- single dashboard -->
                                    <div class="single-dashboard pt-40">
                                        <h5>Achievements</h5>
                                        <p> A creative, resourceful teacher with [number] years of varied instructional experience.
...
As an entry-level teacher, I would love to utilize my energetic attitude and instructional abilities to lead students at [School name].
                                    ...
                                    <div class="single-dashboard pt-40">
                                        <h5>My Objective</h5>
                                        <p>Motivates both his juniors and peers.
• Indulge in postgraduate teaching and training.
This is highly rewarding and provides a sense of
satisfaction and achievement.
• Regularly evaluate him and be open to improvement from whatever source it comes from, even
from the students.  .</p>
                                    </div> <!-- single dashboard -->
                                </div> <!-- dashboard cont -->
                            </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="single-course mt-30">
                                                ...
                                                <div class="cont border">
                                                    ...
                                                    <span>(20 Reviews)</span>
                                                    <a href="#"><h4>Learn basic PHP for beginner</h4></a>
                                                    <div class="course-teacher">
                                                        <div class="thum">
                                                            <a href="#"><img src="images/course/teacher/t-2.jpg" alt="teacher"></a>
                                                        </div>
