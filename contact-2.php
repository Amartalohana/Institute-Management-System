...
<body>
   ...
   <?php include('pages/header.php'); ?>
                        ...
                        <ul>
                            ...
                            <li>
                                <div class="single-address">
                                    ...
                                    <div class="cont">
                                        <p>www.instituteoftechnologies.com</p>
                                        <p>www.iot.com</p>
                                    </div>
                                </div> <!-- single address -->
                            </li>
	...
	if($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$phone = $_POST['phone'];
		$msg = $_POST['message'];
	$sql = "INSERT INTO `contact`(`con_nam`, `con_email`, `con_sub`, `con_ph`, `con_msg`) VALUES ('$name','$email','$subject','$phone','$msg')";
			if ($con->query($sql) === TRUE) {
			echo '<script>';
			echo 'alert("Massage sent ..")';
			echo '</script>';
			} 	
			else {
                ...
                <div class="row">
                    <div class="col-md-8">
                        <div class="copyright text-md-left text-center pt-15">
                            <p>&copy; Copyrights 2019 Amrita </p>
                        </div>
                    </div>
                    <div class="col-md-4">
