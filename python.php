            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="page-banner-cont">
                        <h2>Learn basic PYTHON</h2>
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="index,php">Home</a></li>
                                <li class="breadcrumb-item"><a href="courses.php">Courses</a></li>
                                <li class="breadcrumb-item active" aria-current="page">Learn basic Python</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="courses-single-left mt-30">
                        <div class="title">
                            <h3>Learn basic Python for beginner</h3>
                        </div> <!-- title -->
                        ...
                        <div class="courses-single-image pt-50">
                            <img src="images/course/python-frameworks-250919.png" alt="Courses">
                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="single-description pt-40">
											...
											semantics. Python supports modules and packages, which encourages program modularity and code reuse. </p>
                                        </div>
                                        <div class="single-description pt-40">
                                            <h6>Requirements</h6>
                                            <p>Learn the difference between front-end and back-end

Front-end vs. back-end — what’s the difference? You may have heard the terms “front-end” and “back-end” web development before. 
Keeping track of two types of web development may seem a bit confusing, but it’s actually quite simple.</p>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="curriculum" role="tabpanel" aria-labelledby="curriculum-tab">
                                    <div class="curriculum-cont">
                                        <div class="title">
                                            <h6>Learn basic Python Lecture Started</h6>
                                        </div>
                                                ...
                                                <div class="card-header" id="headingOne">
                                                    <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is Python</span></li>
                                                ...
                                                <div class="card-header" id="headingTow">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseTow" aria-expanded="true" aria-controls="collapseTow">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is python iterator</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingThree">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is python closure</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingFore">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFore" aria-expanded="false" aria-controls="collapseFore">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is  python generator</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingFive">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is python property</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingSix">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is python Regex</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingSeven">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">How to develop applications in python</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                        ...
                                        <ul>
                                           <li>
                                               <div class="single-reviews">
                                                    ...
                                                    <div class="reviews-description pt-20">
                                                        <p>There are best topics in the course</p>
                                                        <div class="rating">
                                                            <ul>
                                           ...
                                           <li>
                                               <div class="single-reviews">
                                                    ...
                                                    <div class="reviews-description pt-20">
                                                        <p> Very well explained course</p>
                                                        <div class="rating">
                                                            <ul>
                                                                <li><i class="fa fa-star"></i></li>
                                                                <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="You-makelike mt-30">
                                ...
                                <div class="single-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="java.php"><h4>Introduction to java</h4></a>
                                        <ul>
                                ...
                                <div class="single-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="android.php"><h4>Basic Android development</h4></a>
                                        <ul>
                                            <li><a href="#"><i class="fa fa-user"></i>31</a></li>
                                            <li>$50</li>
                                        </ul>
