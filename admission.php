...
if ($conn->connect_error) {
   ...
   <!--====== PRELOADER PART START ======-->
        ...
        <div class="container">
            <div class="col-md-6 col-sm-12 col-xs-12">
                <div class="all-title quote-title qu-new">
                    ...
                    <p> The BS Mathematics assists students to enhance their quantitative skills which are highly valued as a mathematician. This degree prepares students for a career in the public and private sectors. The graduates can pursue for further studies, or in work finance, consultancy, advertising, management, banking, marketing, accountancy, commerce, education, research and IT.
                        </p>
                    
                    <p class="help-line">Help Line <span>+92300356749</span> </p> <span class="help-arrow pulse"><i class="fa fa-angle-right" aria-hidden="true"></i></span> </div>
            </div>
                    ...
                    <div class="col s12">
                        <form class="form-horizontal" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="education" type="text" class="form-control" placeholder="Enter your education">
                                </div>
                            </div>
                            <div class="form-group">
							...
							<div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <input name="challan" type="number" class="form-control" placeholder="Enter your challan no" required>
                                </div>
	...
	if ($_SERVER['REQUEST_METHOD']=='POST'){
		...
		$sql = "INSERT INTO `admission` (`fulnam`, `phon`, `email`, `city`, `education`, `course`, `ch.no`) VALUES ('$fname','$phone','$email','$city','$education','$course','$challan')";
		
		if($conn->query($sql) === TRUE){
			
			echo "<script>alert('Form Submitted Successfully');</script>";
			echo '<script>';
			echo 'window.open("admission.php","_self")';
			echo '</script>';
		}else{
