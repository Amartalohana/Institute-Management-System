                    ...
                    <div class="page-banner-cont">
                        ...
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">Learn basic PHP</li>
                            </ol>
                        </nav>
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="courses-single-left mt-30">
                        <div class="title">
                            <h3>Learn basic PHP  for beginner</h3>
                        </div> <!-- title -->
                        ...
                        <div class="courses-single-image pt-50">
                            <img src="images/course/PHP-DEVELOPMENT-Brillmindz.jpg" alt="Courses">
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="single-description pt-40">
                                            ...
                                            <p>PHP is an intuitive, server side scripting language. ... 
											PHP consists of a scripting language and an interpreter. Like other scripting languages, PHP enables web developers to define the behavior and logic they need in a web page. 
											These scripts are embedded into the HTML documents that are served by the web server.</p>
                                        </div>
                                        <div class="single-description pt-40">
                                            <h6>Requirements</h6>
                                            <p> Even though some Chromebooks, Android, iOS and Microsoft Mobile devices can be used for many web-hosted applications 
											and many have apps that work well for accessing various university network-accessible services a computer(laptop/desktop)
											that meets or exceeds the following minimum requirements will give students the best overall learning experience.</p>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="curriculum" role="tabpanel" aria-labelledby="curriculum-tab">
                                    <div class="curriculum-cont">
                                        <div class="title">
                                            <h6>Learn basic PHP Lecture Started</h6>
                                        </div>
                                                ...
                                                <div class="card-header" id="headingOne">
                                                    <a href="#" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is PHP Manual</span></li>
                                                ...
                                                <div class="card-header" id="headingTow">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseTow" aria-expanded="true" aria-controls="collapseTow">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is PHP Files</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingThree">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is PHP Strings</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingFore">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFore" aria-expanded="false" aria-controls="collapseFore">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is PHP Forms</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingFive">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseFive" aria-expanded="false" aria-controls="collapseFive">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is PHP-XML</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingSix">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseSix" aria-expanded="false" aria-controls="collapseSix">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is MySQL Database</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                                                ...
                                                <div class="card-header" id="headingSeven">
                                                    <a href="#" data-toggle="collapse" class="collapsed" data-target="#collapseSeven" aria-expanded="false" aria-controls="collapseSeven">
                                                        <ul>
                                                            ...
                                                            <li><span class="head">What is Web Application Implementation</span></li>
                                                            <li><span class="time d-none d-md-block"><i class="fa fa-clock-o"></i> <span> 00.30.00</span></span></li>
                                                        </ul>
                                                    </a>
                                                </div>
                        ...
                        <div class="col-lg-12 col-md-6">
                            <div class="You-makelike mt-30">
                                ...
                                <div class="single-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="android.php"><h4>Introduction to Android Development</h4></a>
                                        <ul>
                                ...
                                <div class="single-makelike mt-20">
                                    ...
                                    <div class="cont">
                                        <a href="python.php"><h4>Basic python concepts</h4></a>
                                        <ul>
                                            <li><a href="#"><i class="fa fa-user"></i>31</a></li>
                                            <li>$50</li>
                                        </ul>
