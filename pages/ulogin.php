...
if (mysqli_connect_errno())
{
 echo "Failed to connect to MySQL: " . mysqli_connect_error();
    ...
    while($row = $res->fetch_assoc()) {
		$demail = $row["emailid"];
		$dpas = $row["pass"];
		if($email == $demail and $pass == $dpas){
			header('location:../index.php');
		}
		else{
			echo "<script> alert('Either Email Id or Password is Incorrect')</script>";
		}
		}
    ...
    <div class="container">
        <br><br><br><br>
            <div class="col-md-4 col-md-offset-4">
             ...
             <input class="form-control" placeholder="Email Id"  id="email" name="email" type="email" autofocus autocomplete="off">
                                </div>
                                <div class="form-group">
