                                ...
                                <div class="tab-pane fade show active" id="overview" role="tabpanel" aria-labelledby="overview-tab">
                                    <div class="overview-description">
                                        <div class="single-description pt-40">
                                            ...
                                            <p> JavaScript was developed by Brendan Eich in 1995, which appeared in Netscape, a popular browser of that time. The language was initially called LiveScript and was later renamed JavaScript. There are many programmers who think that JavaScript and Java are the same. In fact, JavaScript and Java are very much unrelated.</p>
                                        </div>
                                        <div class="single-description pt-40">
                                            <h6>REQUIREMENTS</h6>
                                            <p>What is JavaScript?
Writing Simple JavaScript Example. .</p>
                                        </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4">
                        <div class="copyright text-md-right text-center pt-15">
                            <p>Designed by <span>amrita</span> </p>
                        </div>
                    </div>
                </div> <!-- row -->
            </div> <!-- container -->
